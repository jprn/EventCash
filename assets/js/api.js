window.EvenCashApi=(function(){
  ...
  return {
    ...
    walletDebit:(qr_token,amount,product_name,stand_name,clientPin)=>request("wallet_debit.php",{method:"POST",body:{qr_token,amount,product_name,stand_name,client_pin:clientPin}}),
    ...
    activateWallet:(wallet_id)=>request("admin_wallet_activate.php",{method:"POST",body:{wallet_id}}),
    deleteWallet:(wallet_id)=>request("admin_wallet_delete.php",{method:"POST",body:{wallet_id}}),
    exportCsvUrl:()=>{
      const {base}=cfg();
