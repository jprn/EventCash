...
<html lang="fr">
  ...
  <body class="stand">
    <div class="container">
      <div class="topbar">
        ...
        <div class="nav" aria-label="Navigation">
          ...
          <a class="active" href="#"><svg viewBox="0 0 24 24"><path d="M6 7h12"/><path d="M6 12h12"/><path d="M6 17h12"/></svg>Buvette</a>
      ...
      <div class="s-hero">
        ...
        <div class="s-title">Buvette</div>
        <p class="s-subtitle" id="standName"></p>
      </div>

      <div class="s-split single">
        <div class="s-card">
          <div class="s-card-body">
            <div class="s-section-title">Scanner le QR Code du client</div>
            <button id="scan" class="s-btn" type="button">
              <svg viewBox="0 0 24 24"><path d="M4 7V5a1 1 0 0 1 1-1h2"/><path d="M20 7V5a1 1 0 0 0-1-1h-2"/><path d="M4 17v2a1 1 0 0 0 1 1h2"/><path d="M20 17v2a1 1 0 0 1-1 1h-2"/><path d="M7 12h10"/></svg>
              Scanner le QR Code
            </button>
            <div class="s-divider"></div>
            <button class="s-btn secondary" type="button" onclick="document.getElementById('token').focus()">
              <svg viewBox="0 0 24 24"><path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h10"/></svg>
              Saisie manuelle
            </button>
            <div style="height:12px"></div>
            <input id="token" class="s-input" placeholder="Coller le token" />
            <div style="height:12px"></div>
            <button id="lookup" class="s-btn secondary" type="button">Charger</button>
          </div>
        </div>
      </div>

      <div style="height:16px"></div>
      <div id="balanceBanner" class="s-balance" style="display:none">
        <div class="s-balanceLeft">
          <div class="s-balanceIcon" aria-hidden="true">
            <svg viewBox="0 0 24 24"><path d="M7 10V7a5 5 0 0 1 10 0v3"/><path d="M6 10h12v10H6z"/></svg>
          </div>
          <div>
            <div class="s-balanceK">Solde disponible</div>
            <div class="s-balanceV" id="walletBalance">0.00€</div>
          </div>
        </div>
        <button id="balanceClose" class="s-balanceClose" type="button" aria-label="Fermer">×</button>
      </div>

      <div style="height:16px"></div>
      <div class="s-card">
        <div class="s-card-body">
          <div class="s-section-title">Produits disponibles</div>
          <div class="s-productList" id="products"></div>
    ...
    <script>window.EVENCASH_STAND_NAME="Buvette";</script>
