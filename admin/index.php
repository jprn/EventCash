<?php $EVENCASH_ROLE = 'admin'; require_once __DIR__ . '/../api/auth_check.php'; ?>
<!doctype html>
<html lang="fr">
  <head>
    <meta charset="utf-8" />
  ...
  <body class="admin">
    <div id="adminLogin" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;text-align:center;padding:24px;background:#fff;">
      <div style="font-size:24px;font-weight:800;margin-bottom:16px;color:#0f172a;">Accès Admin</div>
      <input id="adminPin" type="password" placeholder="Code PIN" style="padding:10px 14px;font-size:16px;border:1px solid #ccc;border-radius:8px;margin-bottom:12px;width:220px;text-align:center;" />
      <button id="adminLoginBtn" type="button" style="padding:10px 18px;font-size:16px;border:none;border-radius:8px;background:#0f172a;color:#fff;cursor:pointer;width:220px;">Valider</button>
      <div id="adminLoginErr" style="color:#d00;margin-top:10px;display:none;">Code incorrect</div>
    </div>
          ...
          <div id="walletPreview" class="a-preview" style="display:none">
            ...
            <div class="a-previewGrid">
              ...
              <div class="a-previewMeta">
                <div class="a-previewRow"><div class="k">PIN</div><div class="v a-token" id="walletPreviewPin"></div></div>
